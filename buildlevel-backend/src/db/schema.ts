...
export const orders = mysqlTable("orders", {
  id: serial("id").primaryKey(),
  orderToken: varchar("orderToken", { length: 128 }),
  customerFirstName: varchar("customerFirstName", { length: 128 }),
  customerLastName: varchar("customerLastName", { length: 128 }),
  ...
  fulfillmentStatus: mysqlEnum("fulfillmentStatus", ["Payment Pending", "Paid", "Order Received", "Awaiting Fulfillment", "Ready for Printify Test", "Processing", "Printify Order Created", "Awaiting Production Approval", "Sent to Production", "In Production", "Partially Shipped", "Shipped", "Delivered", "Fulfillment Payment Issue", "Requires Admin Review", "Failed", "Cancelled"]).notNull().default("Payment Pending"),
  ...
  customerStatus: varchar("customerStatus", { length: 128 }),
  printifyApiResponse: json("printifyApiResponse").$type<Record<string, unknown>>(),
  errorMessage: text("errorMessage"),
  lastSyncAt: timestamp("lastSyncAt"),
  lastSyncFailedAt: timestamp("lastSyncFailedAt"),
  ...
  confirmationEmailStatus: varchar("confirmationEmailStatus", { length: 64 }),
  confirmationEmailError: text("confirmationEmailError"),
  productionEmailSentAt: timestamp("productionEmailSentAt"),
  shippingEmailSentAt: timestamp("shippingEmailSentAt"),
